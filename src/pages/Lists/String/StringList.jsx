...
const StringList = () => {
    ...
    const stringsListRowsPreset = [{
        "stringId": 0, "plantName": "-", "inventerName": 1, "stringName": "-", status: 1, trackerQty: 0, trackerStatus: 0,
        heathMap: "heathMap", "capacity": 0, "instantGeneration": 0, "totalYield": 0, producedEnergy: 0
    }];


    const [stringListData, setStringListData] = useState(stringsListRowsPreset);
    ...
    useEffect(() => {
        ...
        axios.get("https://etta-api.servissoft.net/smartplain//lists/allStringsList", { headers: { "Authorization": `Bearer ${tokenStr}` } })
            .then((response) => {
                setStringListData(response.data);
            });
                ...
                <div
                    ...
                    <Grid container xs={12} lg={12} width="100%"  >
                        ...
                        <Grid item xs={12} lg={12} width="100%"  >
                            <StringListDataTable rows={stringListData} />
                        </Grid>
                    </Grid>
