...
import EnergyFlowstring from "../../assets/images/EnergyFlowstring.png";
...
const StringDetailPage = () => {
    ...
    useEffect(() => {
        ...
        fetchFunc("https://etta-api.servissoft.net/weather/plantInfo/plantWeatherSummary/" + getReduxInfo?.flowPlanttoString?.PlantName ?? "BT1880001104", "plantWeather");
    }, []);
        ...
        <Box sx={{ flexGrow: 1, backgroundColor: "#F8FAFB" }} padding="32px"  >
            <Grid container spacing={2} style={{ margin: 0, width: '100%', }} >
                    ...
                    <Grid item xs={12} lg={12} container display="flex" alignItems="center" >
                        <Grid item xs={12} lg={7} display="flex" alignItems="center" >
                            <span style={{ fontSize: "18px", fontWeight: 600, color: "#202328" }} >
                                {getReduxInfo?.flowPlanttoString?.StringName ?? "String Name"}
                            </span>
                        </Grid>
                ...
                <Grid item xs={12} lg={8} flexGrow={1} >
                    <ItemLoses>
                        <Box fontSize="14px" width="100%" display="flex" flexDirection="row" justifyContent="space-between" sx={{ padding: "0px" }} >
                            <span style={{ fontSize: "18px", fontWeight: 600, lineHeight: "120%", color: "#282B2E" }} >{t('StringInformation')}</span>
                                    ...
                                    <Box height="100%" width="30%" display="flex" justifyContent="center" flexDirection="column">
                                        <Box>
                                            <span style={{ fontSize: "32px", fontWeight: "500" }} >
                                                {getReduxInfo?.flowPlanttoString?.StringName}
                                            </span>
                                        </Box>
                                ...
                                <Box width="100%" display="flex" >
                                    <div className='consumedBorder'>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                            <span className='PlantConsumedInfo'  >{t('online')}  </span>
                                            <span className='consumedInfoDetail' style={{ opacity: "0.5" }} >{t('string-status')} </span>
                                        </div>
                                    </div>
                                    <div className='consumedBorder'>
                                    ...
                                    <div className='consumedBorder'>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                            <span className='PlantConsumedInfo'  >6.52 <span className='consumedInfoDetail'>kWh</span> </span>
                                ...
                                <Box width="100%" display="flex" flexDirection="column" >
                                    ...
                                    <Box width="100%" display="flex" >
                                        <div className='consumedBorder'>
                                            ...
                                            <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                                <span className='PlantConsumedInfo'  >6.52 <span className='consumedInfoDetail'>k</span> </span>
                                        ...
                                        <div className='consumedBorder'>
                                            ...
                                            <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                                <span className='PlantConsumedInfo'  >6.52 <span className='consumedInfoDetail'>k</span> </span>
                                                <span className='consumedInfoDetail' style={{ opacity: "0.5" }}>{t('last-days')}</span>
                                        ...
                                        <div className='consumedBorder'>
                                            <div style={{ marginTop: '-3px' }} > <img src={dolarIcon} alt='' /> </div>
                                            <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                                <span className='PlantConsumedInfo'  >1.52 <span className='consumedInfoDetail'>k</span> </span>
                                                <span className='consumedInfoDetail' style={{ opacity: "0.5" }} >{t('today')}</span>
                                        ...
                                        <div className='consumedBorder'>
                                            <div style={{ marginTop: '-3px' }} > <img src={dolarIcon} alt='' /> </div>
                                            <div style={{ display: "flex", flexDirection: "column", marginLeft: "0.5rem", width: "100%" }}>
                                                <span className='PlantConsumedInfo'  >63.529 <span className='consumedInfoDetail'>k</span> </span>
                                                <span className='consumedInfoDetail' style={{ opacity: "0.5" }}>{t('last-days')}</span>
                ...
                <Grid item xs={12} lg={12} display="flex" alignItems="center" gap="8px" marginTop="24px" >
                    <span className='kpiCompTitle'> {t('stringKPI')} </span>
                    <img src={settingIcon} />
                </Grid>
                ...
                <Grid item xs={12} lg={8}>
                    <ItemRangeArea >
                        <Box width="100%" display="flex" flexDirection="column" >
                            <Box fontSize="14px" width="100%" display="flex" flexDirection="row" justifyContent="space-between" sx={{ marginBottom: '1rem' }} >
                ...
                <Grid item xs={12} lg={4} container>
                    <Grid item xs={12} lg={12} >
                        <div className='circleComponent'>
                            <span style={{ marginBottom: "23px" }} className='CompTitle'> {t('panel-status')} </span>
                ...
                <Grid item xs={12} lg={6}  >
                    ...
                    <Box flexDirection="column" sx={{
                        ...
                        <Box sx={{ width: "100%", height: "100%" }}>
                            <div style={{
                                background: `url(${EnergyFlowstring})`,
                                backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center center",
                                height: "100%", width: "100%"
                            }} >
                                <img style={{ width: "100%", height: "100%", visibility: "hidden" }} src={EnergyFlowstring} alt='' />
                            </div>
                        </Box>
                    </Box>
                </Grid>
                <Grid item xs={12} lg={6} >
                    <Box flexDirection="column" sx={{
                        ...
                        <Box fontSize="14px" width="100%" display="flex" flexDirection="row" justifyContent="space-between"  >
                            <span style={{ color: "#282B2E", fontSize: "12px" }}>DC Power ( kW / kWP)</span>
                            <div >
                ...
                <Grid item xs={12} lg={12} display="flex" justifyContent='center'>
                    <div
                        ...
                        <Grid container xs={12} lg={12} width="100%">
                            <Grid item xs={12} lg={7} display="flex" alignItems='center'>
                                <span style={{ fontSize: "18px", fontWeight: 600 }}  >{t('panelList')} </span>
                            </Grid>
